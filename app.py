...
def obter_dados_cidade(cidades):
    print('Obtendo dados para as cidades...')
...
with concurrent.futures.ThreadPoolExecutor() as executor:
    future_cidade_part1 = executor.submit(obter_dados_cidade, cidades_part1)
    future_cidade_part2 = executor.submit(obter_dados_cidade, cidades_part2)
    future_cidade_part3 = executor.submit(obter_dados_cidade, cidades_part3)
    future_cidade_part4 = executor.submit(obter_dados_cidade, cidades_part4)
